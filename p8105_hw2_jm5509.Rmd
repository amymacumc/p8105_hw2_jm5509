...
**`r ncol(alltrash_df)`  variables**. Simply speaking, it is like put the 
proftrash_df at the bottom of mrtrash_df since the 2 dataframes have exactly 
the same variable names. However, they could also be easily distinguished by the
