...
```
    ...
    ## # … with 455 more rows, 9 more variables: route7 <chr>, route8 <chr>,
    ## #   route9 <chr>, route10 <chr>, route11 <chr>, entry <lgl>, vending <chr>,
    ## #   entrance_type <chr>, ada <lgl>, and abbreviated variable names
    ## #   ¹​station_name, ²​station_latitude, ³​station_longitude
...
```
    ...
    ##  1 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route1  R      
    ##  2 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route2  <NA>   
    ##  3 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route3  <NA>   
    ##  4 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route4  <NA>   
    ##  5 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route5  <NA>   
    ##  6 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route6  <NA>   
    ##  7 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route7  <NA>   
    ##  8 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route8  <NA>   
    ##  9 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route9  <NA>   
    ## 10 4 Avenue 25th St     40.7   -74.0 TRUE  YES     Stair   FALSE route10 <NA>   
    ## # … with 20,538 more rows, and abbreviated variable names ¹​station_name,
    ## #   ²​station_latitude, ³​station_longitude, ⁴​entrance_type, ⁵​route_name,
    ## #   ⁶​route_number
...
This produces a tibble of **71 observations** and **14 variables**.The
key variables include *dump_num*, *year*, *weight_tons*,
*sports_balls*,etc.
...
In this way, I get a tibble of **524 observations** and **15
variables**. Simply speaking, it is like put the proftrash_df at the
bottom of mrtrash_df since the 2 dataframes have exactly the same
variable names. However, they could also be easily distinguished by the
different corresponding value of variable “label”.

The illustrate the information of the datasets,better, we can extract
some of the info we want. For example, we can caculate the sum of
...
and organize so that year and month are the leading columns. Note that
again for consistency again datasets, we will replace month number with
month name.
